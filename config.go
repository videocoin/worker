...
type Config struct {
	...
	VerifierHTTPADDR string `required:"true" envconfig:"VERIFIER_RPC_ADDR" default:"http://verifier:50054"`
	...
	ManagerHTTPADDR  string `required:"true" envconfig:"MANAGER_RPC_ADDR" default:"http://manager:50053"`
