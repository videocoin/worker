...
func (ProfileId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_profiles_cad571c8a9d46d65, []int{0}
}
...
func (*Profile) Descriptor() ([]byte, []int) {
	return fileDescriptor_profiles_cad571c8a9d46d65, []int{1}
}
...
func init() {
	proto.RegisterFile("profiles/v1/profiles.proto", fileDescriptor_profiles_cad571c8a9d46d65)
}
func init() {
	golang_proto.RegisterFile("profiles/v1/profiles.proto", fileDescriptor_profiles_cad571c8a9d46d65)
}

var fileDescriptor_profiles_cad571c8a9d46d65 = []byte{
