...
import (
	...
	"github.com/videocoin/telegraf/filter"
	"github.com/videocoin/telegraf/core"
	"github.com/videocoin/telegraf/metric"
	"github.com/videocoin/telegraf/plugins/processors"
)
...
func New() *TopK {
	...
	// Setup defaults
	topk.Period = core.Duration{Duration: time.Second * time.Duration(10)}
	topk.K = 10
